...
12: [
  { ru: "актер", en: "actor", type: "noun" },
  { ru: "квартира", en: "apartment", type: "noun" },
  { ru: "атлет, спортсмен", en: "athlete", type: "noun" },
  { ru: "тетя", en: "aunt", type: "noun" },
  { ru: "быть женатым на /быть замужем за", en: "be married (to ...)", type: "verb" },
  { ru: "брат", en: "brother", type: "noun" },
  { ru: "бык", en: "bull", type: "noun" },
  { ru: "бизнесмен, деловой человек", en: "businessman", type: "noun" },
  { ru: "ребенок", en: "child", type: "noun" },
  { ru: "дети", en: "children", type: "noun" },
  { ru: "деревня, сельская местность", en: "country (village)", type: "noun" },
  { ru: "двоюродный брат, кузен", en: "cousin", type: "noun" },
  { ru: "дочь", en: "daughter", type: "noun" },
  { ru: "эпизод", en: "episode", type: "noun" },
  { ru: "невероятный, сказочный", en: "fabulous", type: "adjective" },
  { ru: "завод, фабрика", en: "factory", type: "noun" },
  { ru: "семья", en: "family", type: "noun" },
  { ru: "член семьи", en: "family member", type: "noun" },
  { ru: "отец", en: "father", type: "noun" },
  { ru: "любимый", en: "favorite", type: "adjective" },
  { ru: "женского пола", en: "female", type: "adjective" },
  { ru: "внук, внучка", en: "grandchild", type: "noun" },
  { ru: "внуки", en: "grandchildren", type: "noun" },
  { ru: "внучка", en: "granddaughter", type: "noun" },
  { ru: "дедушка", en: "grandfather", type: "noun" },
  { ru: "бабушка", en: "grandmother", type: "noun" },
  { ru: "дедушка с бабушкой", en: "grandparent(s)", type: "noun" },
  { ru: "внук", en: "grandson", type: "noun" },
  { ru: "иметь", en: "have (has)", type: "verb" },
  { ru: "Сколько...?", en: "How many ... ?", type: "other" },
  { ru: "муж", en: "husband", type: "noun" },
  { ru: "мужского пола", en: "male", type: "adjective" },
  { ru: "значить иметь ввиду", en: "mean", type: "verb" },
  { ru: "модель", en: "model", type: "noun" },
  { ru: "мать", en: "mother", type: "noun" },
  { ru: "кино", en: "movie", type: "noun" },
  { ru: "мистический", en: "mystery", type: "adjective" },
  { ru: "племянник", en: "nephew", type: "noun" },
  { ru: "племянница", en: "niece", type: "noun" },
  { ru: "роман", en: "novel", type: "noun" },
  { ru: "занятие, профессия", en: "occupation", type: "noun" },
  { ru: "родитель", en: "parent(s)", type: "noun" },
  { ru: "человек, личность", en: "person", type: "noun" },
  { ru: "домашний питомец", en: "pet", type: "noun" },
  { ru: "имущество, собственность", en: "possession", type: "noun" },
  { ru: "открытка", en: "post-card", type: "noun" },
  { ru: "вопросник, анкета", en: "questionnaire", type: "noun" },
  { ru: "ранчо, крупное фермерское хозяйство", en: "ranch", type: "noun" },
  { ru: "богатый", en: "rich", type: "adjective" },
  { ru: "рок певец", en: "rock singer", type: "noun" },
  { ru: "серия", en: "series", type: "noun" },
  { ru: "сестра", en: "sister", type: "noun" },
  { ru: "сын", en: "son", type: "noun" },
  { ru: "студия", en: "studio", type: "noun" },
  { ru: "рассказывать", en: "tell", type: "verb" },
  { ru: "дядя", en: "uncle", type: "noun" },
  { ru: "смотреть, наблюдать", en: "watch (v)", type: "verb" },
  { ru: "Какой (твой) любимый... ?", en: "What's (your) favorite ... ?", type: "phrase" },
  { ru: "Кто (твой) любимый...?", en: "Who is (your) favorite ... ?", type: "phrase" },
  { ru: "жена", en: "wife", type: "noun" },
  { ru: "побеждать", en: "win", type: "verb" },
  { ru: "писатель(ница)", en: "writer", type: "noun" }
],
13: [
  { ru: ".... знаете ли", en: ".... you know.", type: "phrase" },
  { ru: "около (35)", en: "about (35)", type: "other" },
  { ru: "актриса", en: "actress", type: "noun" },
  { ru: "посол", en: "ambassador", type: "noun" },
  { ru: "приблизительно", en: "around", type: "other" },
  { ru: "средний", en: "average", type: "adjective" },
  { ru: "среднего телосложения", en: "average build", type: "phrase" },
  { ru: "среднего роста", en: "average height", type: "phrase" },
  { ru: "балкон", en: "balcony", type: "noun" },
  { ru: "бейсболист", en: "baseball player", type: "noun" },
  { ru: "борода", en: "beard", type: "noun" },
  { ru: "белокурый", en: "blond", type: "adjective" },
  { ru: "блузка", en: "blouse", type: "noun" },
  { ru: "синеватый", en: "bluish", type: "adjective" },
  { ru: "шапка", en: "cap", type: "noun" },
  { ru: "шофер", en: "chauffeur", type: "noun" },
  { ru: "одежда", en: "clothes", type: "noun" },
  { ru: "пальто", en: "coat", type: "noun" },
  { ru: "колледж", en: "college", type: "noun" },
  { ru: "кудрявый, кучерявый", en: "curly", type: "adjective" },
  { ru: "темный", en: "dark", type: "adjective" },
  { ru: "Разве вы не знаете?", en: "Don't you know?", type: "phrase" },
  { ru: "платье", en: "dress", type: "noun" },
  { ru: "водить машину", en: "drive", type: "verb" },
  { ru: "серьга", en: "earring", type: "noun" },
  { ru: "старше", en: "elderly", type: "adjective" },
  { ru: "точно", en: "exactly", type: "other" },
  { ru: "довольно низкий", en: "fairly short", type: "phrase" },
  { ru: "довольно высокий", en: "fairly tall", type: "phrase" },
  { ru: "догадываться", en: "figure out", type: "verb" },
  { ru: "очки", en: "glasses", type: "noun" },
  { ru: "привлекательный", en: "good-looking", type: "adjective" },
  { ru: "волосы", en: "hair", type: "noun" },
  { ru: "шляпа", en: "hat", type: "noun" },
  { ru: "тучный", en: "heavy", type: "adjective" },
  { ru: "горничная", en: "housekeeper", type: "noun" },
  { ru: "Мне это (не) очень нравиться", en: "I (don't) like it very much.", type: "phrase" },
  { ru: "Я точно не знаю.", en: "I don't know exactly.", type: "phrase" },
  { ru: "Я знаю...", en: "I know ...", type: "phrase" },
  { ru: "Я предполагаю...", en: "I suppose ...", type: "phrase" },
  { ru: "куртка", en: "jacket", type: "noun" },
  { ru: "светлый", en: "light", type: "adjective" },
  { ru: "длинный", en: "long", type: "adjective" },
  { ru: "выглядеть, быть похожим", en: "look like", type: "verb" },
  { ru: "средних лет", en: "middle-aged", type: "adjective" },
  { ru: "мисс", en: "Miss", type: "noun" },
  { ru: "усы", en: "mustache", type: "noun" },
  { ru: "диктор", en: "newscaster", type: "noun" },
  { ru: "противоположный", en: "opposite", type: "adjective" },
  { ru: "брюки", en: "pants", type: "noun" },
  { ru: "вечеринка", en: "party", type: "noun" },
  { ru: "политик", en: "politician", type: "noun" },
  { ru: "гонцик", en: "race car driver", type: "noun" },
  { ru: "звонить", en: "ring", type: "verb" },
  { ru: "видеть", en: "see", type: "verb" },
  { ru: "низкий, короткий", en: "short", type: "adjective" },
  { ru: "с коротким рукавом", en: "short-sleeved", type: "adjective" },
  { ru: "юбка", en: "skirt", type: "noun" },
  { ru: "худой", en: "slim", type: "adjective" },
  { ru: "кроссовки", en: "sneakers", type: "noun" },
  { ru: "носок", en: "sock", type: "noun" },
  { ru: "костюм", en: "suit", type: "noun" },
  { ru: "высокий", en: "tall", type: "adjective" },
  { ru: "Это ужасно!", en: "That's terrible!", type: "phrase" },
  { ru: "футболка", en: "T-shirt", type: "noun" },
  { ru: "поворачивать", en: "turn", type: "verb" },
  { ru: "носить", en: "wear", type: "verb" },
  { ru: "Как он/она выглядит?", en: "What does he/she look like?", type: "phrase" },
  { ru: "Что он /она любит?", en: "What's he/she like?", type: "phrase" },
  { ru: "порядок слов", en: "word order", type: "noun" },
  { ru: "молодой, юный", en: "young", type: "adjective" }
]
